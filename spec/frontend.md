...
Launch arguments: `--listen 127.0.0.1:0 --token <auth_token>` 
(port 0 = OS-assigned; `<auth_token>` is a secure random string generated by the GUI on startup to authenticate gRPC requests).
